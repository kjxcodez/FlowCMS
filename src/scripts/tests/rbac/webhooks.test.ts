import { GET as getWebhooks, POST as createWebhook, DELETE as deleteWebhook } from "../../../app/api/internal/webhooks/route";
import { POST as replayWebhook } from "../../../app/api/internal/webhooks/deliveries/[id]/replay/route";
